                    ...
                    <HalfColumn>
                        <div className="social-ch">
                            ...
                            <div className="description">
                                <p>
                                    Come and help us grow the POKT community
                                    alongside the protocol. Join our social
                                    media channels.
                                </p>
                            </div>
                        </div>
                            ...
                            <ul className="menu-footer">
                                <li className="mainli">
                                    ...
                                    <ul className="sub-menu">
                                        ...
                                        <li className="menu-item">
                                            <a
                                                href={
                                                    Config.BLOCK_EXPLORER_BASE_URL
                                                }
                                            >
                                                Block Explorer
                                            </a>
                                ...
                                <li className="mainli">
                                    ...
                                    <ul className="sub-menu">
                                        ...
                                        <li className="menu-item">
                                            <a href="https://docs.pokt.network/">
                                                Dev Portal
                                            </a>
                                        </li>
                                        <li className="menu-item">
                                ...
                                <li className="mainli">
                                    ...
                                    <ul className="sub-menu">
                                        <li className="menu-item">
                                            <a href="https://pokt.network/contact/">
                                                Contact Us
                                            </a>
                                        </li>
                                        <li className="menu-item">
                                            <a href="https://pokt.network/blog/">
                                                Blog
                                            </a>
                                        </li>
                                        <li className="menu-item">
                                            <a href="https://forum.pokt.network/">
                                                Forum
                                            </a>
                                        </li>
                                        <li className="menu-item">
