...
class AccountLatest extends Component {
                    ...
                    if (attributes[1].key === "amount") {
                        ...
                        const imageSrc =
                            tx.type.toLowerCase() === "sent"
                                ...
                                : receivedImgSrc;
                        const TrClass =
                            document.getElementById("tr-element").className;
                        const TdClass =
                            document.getElementById("td-element").className;
                        ...
                        const txTemplate =
                            ...
                            '"> <div class="qty">' +
                            value / 1000000 +
                            ' <span>POKT</span></div> <div class="status">' +
                            tx.type.toLowerCase() +
                            "</div> </Td>\n" +
                            '<Td class="' +
                            TdClass +
                        ...
                        const toTxDetail = document.getElementById(
                            `txHashElement${idCounter}`
                        );

                        if (toTxDetail) {
                            toTxDetail.addEventListener("click", () => {
                                this.pushToTxDetail(txHash);
                            });
                        }
                        idCounter++;
                    } else {
    ...
    async addApp() {
        const { app, stakedImgSrc, unstakingImgSrc, unstakedImgSrc } =
            this.state;
        ...
        if (app !== undefined) {
            ...
            obj.stakedTokens = (
                Number(app.stakedTokens.toString()) / 1000000
            ).toFixed(3);
    ...
    async addNode() {
        const { node, stakedImgSrc, unstakingImgSrc, unstakedImgSrc } =
            this.state;
        ...
        if (node !== undefined) {
            // Update the staked amount
            obj.stakedTokens = (
                Number(node.stakedTokens.toString()) / 1000000
            ).toFixed(3);
    ...
    async getBalance(addressHex) {
        if (addressHex) {
            ...
            const usdBalance = (
                balance * Number(Config.POKT_USD_VALUE)
            ).toFixed(2);
                ...
                <Wrapper className="wide-block-wr">
                            ...
                            >
                                <div className="stat">
                                    <img
                                        ...
                                        onMouseOut={() =>
                                            this.reloadBtnState(false)
                                        }
                                        onMouseOver={() =>
                                            this.reloadBtnState(true)
                                        }
                                        style={{
                                            src: `${
                                                hovered ? reloadActive : reload
                                            }`,
                                            cursor: "pointer",
                                            display: "none",
                                        }}
                    ...
                    <div className="pokt-options">
                        ...
                        <div
                            style={{
                                display:
                                    displayNormalAccount === true
                                        ? "flex"
                                        : "none",
                            }}
                            id="normal-type-section"
                            className="container"
                        >
                            ...
                            <div className="option">
                                <div className="heading">
                                    <img
                                        ...
                                        id="node-stake-status-img"
                                        src={nodeStakingStatusImg}
                                        alt="staked tokens"
                                    />
                                    <h2
                                        style={{
                            ...
                            <div className="option">
                                <div className="heading">
                                    <img
                                        ...
                                        id="app-stake-status-img"
                                        src={appStakingStatusImg}
                                        alt="staked tokens"
                                    />
                                    <h2
                                        style={{
                        ...
                        <div className="btn-subm">
                            <Button
                                target="_target"
                                href={Config.BUY_POKT_BASE_URL}
                                dark
                            >
                                Buy POKT
                            </Button>
                            <Button id="send-pokt" onClick={this.pushToSend}>
                                Send
                            </Button>
                        </div>
                    </div>
                    <form className="pass-pk">
                        <div className="container">
                            <div className="cont-input">
                                ...
                                <Input
                                    style={{ height: "11px", fontSize: "12px" }}
                                    type="text"
                                    name="address"
                                    id="address"
                                    defaultValue={addressHex}
                                    readOnly={true}
                                />
                                <span
                            ...
                            <div className="cont-input third">
                                <Button id="reveal-pk" onClick={this.showModal}>
                                    Reveal Private Key
                                </Button>
                            </div>
                        </div>
                    ...
                    <div className="toggle-btn">
                        <ToggleBtn
                            style={{
                                display:
                                    noTransactions === true ? "block" : "none",
                            }}
                        >
                            No Transactions
                        </ToggleBtn>
                        <ToggleBtn
                            style={{
                                display:
                                    noTransactions === true ? "none" : "block",
                            }}
                            id="tooglebtn"
                    ...
                    <ContainerToggle isVisible={visibility}>
                        <T>
                            ...
                            <TBody
                                ...
                                id="transation-list-section"
                                className="l-tx table-scroll"
                            >
                ...
                >
                    <div className="cont-input" style={{ textAlign: "center" }}>
                        <label
                            style={{
                                display:
                                    isModalVisible === true ? "block" : "none",
                            }}
                            id="passphrase-label"
                        ...
                        <div
                            ...
                            style={{
                                display:
                                    displayPkReveal === true ? "block" : "none",
                            }}
                        >
                            <label
                                id="private-key-label"
                                className="passphrase-label"
                                htmlFor="private"
                            >
                                PRIVATE KEY
                            ...
                            <Input
                                ...
                                defaultValue={privateKey ? privateKey : ""}
                                readonly
                            />
                            <span
                    ...
                    <span
                        ...
                        className="error"
                        style={{
                            display: displayError === true ? "block" : "none",
                        }}
                    >
                    ...
                    <Button
                        style={{
                            ...
                            width: "119px",
                            display:
                                displayPkReveal === true ? "none" : "block",
                            padding: "9px 6px",
                    ...
                    <div className="alert">
                        ...
                        <div className="cont-alert">
                            ...
                            <p>
                                You wont be able to reveal it again or restore
                                it. Make a back up and store it safely,
                                preferably offline. You’ll need it to access
                                your account.
                            </p>
                        </div>
                    </div>
