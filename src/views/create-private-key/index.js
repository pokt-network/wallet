                        ...
                        <div className="container">
                            ...
                            <div className="alert">
                                ...
                                <div className="cont-alert">
                                    ...
                                    <p>
                                        You wont be able see it again or change
                                        it, make a back up, store it save
                                        preferably offline. You’ll need it to
                                        acces your account again.
                                    </p>
                                </div>
                            </div>
                            <div className="cont-input second">
                                ...
                                <Input
                                    ...
                                    id="add"
                                    defaultValue={
                                        this.currentAccount.addressHex || ""
                                    }
                                    disabled
                                />
                            </div>
                            <div className="cont-input">
                                ...
                                <Input
                                    ...
                                    id="puk"
                                    defaultValue={
                                        this.currentAccount.publicKeyHex || ""
                                    }
                                    disabled
                                />
                            </div>
