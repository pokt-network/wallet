    ...
    async handleDownload() {
        ...
        if (ppk === undefined) {
            this.setState({
                errorLabel: {
                    show: true,
                    message: "Can't download if no account was created.",
                },
            });
            return;
        }
        ...
        const dataStr =
            "data:text/json;charset=utf-8," + encodeURIComponent(ppk);
    ...
    pushToAccountDetail() {
        ...
        if (!keyFileDownloaded) {
            this.setState({
                errorLabel: {
                    show: true,
                    message: "Please download your key file before proceeding.",
                },
            });
        ...
        if (
            ...
            this.toggleError(
                true,
                "No account available, please create an account"
            );
    ...
    async handleCreateAccount() {
        ...
        if (passphrase === confirmPassphrase && this.state.validPassphrase) {
            ...
            this.setState({
                errorLabel: {
                    show: true,
                    message: "The passphrase does not fit the requirements",
                },
            });
        }
    }
            ...
            <CreateContent>
                <Wrapper className="wide-block-wr">
                    ...
                    <div className="passphrase">
                        <h2 id="top">
                            PROTECT YOUR POCKET ACCOUNT
                            <br /> WITH a passphrase
                        </h2>
                        <p>
                            Write down a Passphrase to protect your key file.
                            This should have: minimum 15 alphanumeric symbols,
                            one capital letter, one lowercase, one special
                        ...
                        <form className="pass-form">
                            <div className="cont-input">
                                ...
                                <span
                                    ...
                                    id="passphraseError"
                                    className="error passphrase-error"
                                >
                                    {" "}
                        ...
                        <a
                            style={{ display: "block", marginTop: "26px" }}
                            href="/import"
                            className="account"
                        >
                            Already have an account? Access my Pocket account
                        </a>
                    </div>
                    <div className="alert">
                        ...
                        <div className="cont-alert">
                            ...
                            <p>
                                You won't be able see it again or change it;
                                make a back up and store it safely, preferably
                                offline. You’ll need it to access your account
                                again.
                            </p>
                        </div>
                    </div>
                    <div className="container account-info">
                        <div className="cont-input second">
                            <label className="account-info-label" htmlFor="add">
                                ADDRESS
                            </label>
                            <Input
                                style={{
                        ...
                        <div className="btn-subm account-details">
                            <Button
                                ...
                                onClick={this.pushToAccountDetail}
                            >
                                Account Details
                            </Button>
                        </div>
